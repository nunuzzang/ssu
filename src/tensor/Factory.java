...
public class Factory {
    ...
    //04
    public static Vector createVector(int i, int j, int n) { return new VectorImpl(i, j, n); }
    //05
    ...
    //08
    public static Matrix createMatrix(String csvPath) throws IOException { return new MatrixImpl(csvPath); }
    //09
